...
CREATE TABLE universe_history (name TEXT, generic_name TEXT, is_desktop INTEGER, category TEXT, arch TEXT, version TEXT, yversion TEXT, priority TEXT, install TEXT, license TEXT, homepage TEXT, repo TEXT, size INTEGER, sha TEXT, build_date INTEGER, uri TEXT, description TEXT,installed INTEGER DEFAULT 0, data_count INTEGER, PRIMARY KEY(name,version));
