...
CREATE TABLE universe_data (name TEXT, version TEXT, data_name TEXT, data_format TEXT, data_size INTEGER, data_install_size INTEGER, data_depend TEXT, data_bdepend TEXT, data_recommended TEXT, data_conflict TEXT, data_replace TEXT);

CREATE TABLE universe_testing (name TEXT, generic_name TEXT, is_desktop INTEGER, category TEXT, arch TEXT, version TEXT, exec TEXT, rir INTEGER, priority TEXT, install TEXT, license TEXT, homepage TEXT, repo TEXT, size INTEGER, sha TEXT, build_date INTEGER, packager TEXT, uri TEXT, description TEXT,installed INTEGER DEFAULT 0, can_update INTEGER DEFAULT 0, data_count INTEGER, PRIMARY KEY(name));

CREATE TABLE universe_testing_data (name TEXT, version TEXT, data_name TEXT, data_format TEXT, data_size INTEGER, data_install_size INTEGER, data_depend TEXT, data_bdepend TEXT, data_recommended TEXT, data_conflict TEXT, data_replace TEXT);
...
CREATE TABLE universe_history_data (name TEXT, version TEXT, data_name TEXT, data_format TEXT, data_size INTEGER, data_install_size INTEGER, data_depend TEXT, data_bdepend TEXT, data_recommended TEXT, data_conflict TEXT, data_replace TEXT);
...
INSERT INTO source (name, repo, last_update, last_check, has_new, checksum) VALUES ('universe', 'stable', 0, 0, 0, 'a' );
INSERT INTO source (name, repo, last_update, last_check, has_new, checksum) VALUES ('universe', 'testing', 0, 0, 0, 'a' );
